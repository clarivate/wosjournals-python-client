...
from clarivate.wos_journals.client.api.journals_api import JournalsApi  # noqa: E501
...
class TestJournalsApi(unittest.TestCase):
    ...
    def test_journals_id_cited_year_year_get(self):
        """Test case for journals_id_cited_year_year_get

        Get journals that cite the journal for the JCR year  # noqa: E501
        """
        pass

    def test_journals_id_citing_year_year_get(self):
        """Test case for journals_id_citing_year_year_get
    ...
    def test_journals_id_history_get(self):
        """Test case for journals_id_history_get

        Get journal history by id  # noqa: E501
        """
        pass

    def test_journals_id_reports_year_year_get(self):
        """Test case for journals_id_reports_year_year_get
