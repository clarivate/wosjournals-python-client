...
from clarivate.wos_journals.client.api.categories_api import CategoriesApi  # noqa: E501
...
class TestCategoriesApi(unittest.TestCase):
    ...
    def test_categories_id_cited_year_year_get(self):
        """Test case for categories_id_cited_year_year_get

        Get journals that cite all journals in the category for the JCR year  # noqa: E501
        """
        pass

    def test_categories_id_citing_year_year_get(self):
        """Test case for categories_id_citing_year_year_get
    ...
    def test_categories_id_reports_year_year_get(self):
        """Test case for categories_id_reports_year_year_get
