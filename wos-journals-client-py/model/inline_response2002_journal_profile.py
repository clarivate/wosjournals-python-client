...
def lazy_import():
    ...
    globals()['InlineResponse2002JournalProfileOccurrenceOrganizations'] = InlineResponse2002JournalProfileOccurrenceOrganizations


class InlineResponse2002JournalProfile(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'citable_items': (InlineResponse2002JournalProfileCitableItems,),  # noqa: E501
            'citations': (InlineResponse2002JournalProfileCitations,),  # noqa: E501
            'occurrence_countries': ([InlineResponse2002JournalProfileOccurrenceCountries],),  # noqa: E501
            'occurrence_organizations': ([InlineResponse2002JournalProfileOccurrenceOrganizations],),  # noqa: E501
        }
    ...
    attribute_map = {
        'start_year': 'startYear',  # noqa: E501
        'end_year': 'endYear',  # noqa: E501
        'citable_items': 'citableItems',  # noqa: E501
        'citations': 'citations',  # noqa: E501
        'occurrence_countries': 'occurrenceCountries',  # noqa: E501
        'occurrence_organizations': 'occurrenceOrganizations',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """InlineResponse2002JournalProfile - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_year (int): First year of the profile. [optional]  # noqa: E501
            end_year (int): Last year of the profile (equal to the Report year). [optional]  # noqa: E501
            citable_items (InlineResponse2002JournalProfileCitableItems): [optional]  # noqa: E501
            citations (InlineResponse2002JournalProfileCitations): [optional]  # noqa: E501
            occurrence_countries ([InlineResponse2002JournalProfileOccurrenceCountries]): Information about of the top 10 countries and regions that have published materials in this journal in the past three years.. [optional]  # noqa: E501
            occurrence_organizations ([InlineResponse2002JournalProfileOccurrenceOrganizations]): Information about of the top 10 organizations that have published materials in this journal in the past three years.. [optional]  # noqa: E501
        """
