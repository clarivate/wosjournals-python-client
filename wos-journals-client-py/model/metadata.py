...
class Metadata(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            total (int): Total number of records for the request.. [optional]  # noqa: E501
            page (int): Page number (default is 1). [optional]  # noqa: E501
            limit (int): Number of records on a page (default is 10).. [optional]  # noqa: E501
        """
