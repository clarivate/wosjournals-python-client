...
def lazy_import():
    ...
    globals()['JifAggregate'] = JifAggregate


class Jif(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'aggregate': (JifAggregate,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Jif - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            aggregate (JifAggregate): [optional]  # noqa: E501
        """
