...
def lazy_import():
    ...
    globals()['CategoryListRecord'] = CategoryListRecord
    globals()['Metadata'] = Metadata


class CategoryList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hits': ([CategoryListRecord],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            hits ([CategoryListRecord]): List of retrieved categories. [optional]  # noqa: E501
        """
