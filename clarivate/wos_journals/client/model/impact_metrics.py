...
class ImpactMetrics(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'total_cites': (int,),  # noqa: E501
            'jif': (str,),  # noqa: E501
            'jif_without_self_citations': (str,),  # noqa: E501
            'jif5_years': (float,),  # noqa: E501
            'immediacy_index': (float,),  # noqa: E501
            'jci': (float,),  # noqa: E501
        }
    ...
    attribute_map = {
        'total_cites': 'totalCites',  # noqa: E501
        'jif': 'jif',  # noqa: E501
        'jif_without_self_citations': 'jifWithoutSelfCitations',  # noqa: E501
        'jif5_years': 'jif5Years',  # noqa: E501
        'immediacy_index': 'immediacyIndex',  # noqa: E501
        'jci': 'jci',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ImpactMetrics - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total_cites (int): The total number of times that a journal has been cited by all journals included in the database in the JCR year. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor38). [optional]  # noqa: E501
            jif (str): Journal Impact Factor. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor28). [optional]  # noqa: E501
            jif_without_self_citations (str): Journal Impact Factor without self cites.. [optional]  # noqa: E501
            jif5_years (float): Average number of times articles from the journal published in the past five years have been cited in the JCR year. [optional]  # noqa: E501
            immediacy_index (float): Average number of times an article is cited in the year it is published. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor25). [optional]  # noqa: E501
            jci (float): The Journal Citation Indicator is a new field-normalized metric that is calculated for all journals in the Web of Science Core Collection. The value represents the average category-normalized citation impact for papers published in the prior three-year period.. [optional]  # noqa: E501
        """
