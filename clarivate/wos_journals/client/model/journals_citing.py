...
def lazy_import():
    ...
    globals()['JournalsCitingHits'] = JournalsCitingHits
    globals()['Metadata'] = Metadata


class JournalsCiting(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hits': ([JournalsCitingHits],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JournalsCiting - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            hits ([JournalsCitingHits]): [optional]  # noqa: E501
        """
