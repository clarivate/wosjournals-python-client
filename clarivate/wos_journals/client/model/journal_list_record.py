...
def lazy_import():
    ...
    globals()['JournalListRecordJournalCitationReports'] = JournalListRecordJournalCitationReports
    globals()['JournalListRecordMetrics'] = JournalListRecordMetrics
    globals()['JournalListRecordRanks'] = JournalListRecordRanks
    globals()['SearchMatch'] = SearchMatch


class JournalListRecord(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'journal_citation_reports': ([JournalListRecordJournalCitationReports],),  # noqa: E501
            'metrics': (JournalListRecordMetrics,),  # noqa: E501
            'ranks': (JournalListRecordRanks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JournalListRecord - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            journal_citation_reports ([JournalListRecordJournalCitationReports]): Journal citation report link (only if the filter \"jcrYear\" was selected). [optional]  # noqa: E501
            metrics (JournalListRecordMetrics): [optional]  # noqa: E501
            ranks (JournalListRecordRanks): [optional]  # noqa: E501
        """
