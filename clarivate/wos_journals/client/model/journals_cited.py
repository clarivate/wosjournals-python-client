...
def lazy_import():
    ...
    globals()['JournalsCitedHits'] = JournalsCitedHits
    globals()['Metadata'] = Metadata


class JournalsCited(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hits': ([JournalsCitedHits],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JournalsCited - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            hits ([JournalsCitedHits]): [optional]  # noqa: E501
        """
