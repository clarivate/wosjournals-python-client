...
def lazy_import():
    ...
    globals()['Cites'] = Cites
    globals()['JournalsCitesJournal'] = JournalsCitesJournal


class JournalsCitedHits(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'journal': (JournalsCitesJournal,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JournalsCitedHits - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            journal (JournalsCitesJournal): [optional]  # noqa: E501
