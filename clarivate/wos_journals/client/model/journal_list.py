...
def lazy_import():
    ...
    globals()['JournalListRecord'] = JournalListRecord
    globals()['Metadata'] = Metadata


class JournalList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hits': ([JournalListRecord],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JournalList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            hits ([JournalListRecord]): [optional]  # noqa: E501
        """
