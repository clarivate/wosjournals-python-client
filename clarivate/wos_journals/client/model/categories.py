...
class Categories(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): List of journal categories with related editions/databases.  # noqa: E501

        Keyword Args:
            value ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): List of journal categories with related editions/databases.  # noqa: E501
