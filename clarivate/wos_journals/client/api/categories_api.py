...
class CategoriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.categories_id_cited_year_year_get_endpoint = _Endpoint(
            settings={
                'response_type': (CategoriesCited,),
                'auth': [],
        ...
        self.categories_id_citing_year_year_get_endpoint = _Endpoint(
            settings={
                'response_type': (CategoriesCiting,),
                'auth': [],
        ...
        self.categories_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (CategoryRecord,),
                'auth': [],
        ...
        self.categories_id_reports_year_year_get_endpoint = _Endpoint(
            settings={
                'response_type': (CategoryReports,),
                'auth': [],
    ...
    def categories_id_cited_year_year_get(
        self,
        id,
        year,
        **kwargs
        ...
        kwargs['year'] = \
            year
        return self.categories_id_cited_year_year_get_endpoint.call_with_http_info(**kwargs)

    def categories_id_citing_year_year_get(
        self,
        id,
        year,
        **kwargs
        ...
        kwargs['year'] = \
            year
        return self.categories_id_citing_year_year_get_endpoint.call_with_http_info(**kwargs)
    ...
    def categories_id_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.categories_id_get_endpoint.call_with_http_info(**kwargs)

    def categories_id_reports_year_year_get(
        self,
        id,
        year,
        **kwargs
        ...
        kwargs['year'] = \
            year
        return self.categories_id_reports_year_year_get_endpoint.call_with_http_info(**kwargs)
