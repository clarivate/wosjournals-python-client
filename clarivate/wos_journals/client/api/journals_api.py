...
from clarivate.wos_journals.client.api_client import ApiClient, Endpoint as _Endpoint
...
class JournalsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.journals_get_endpoint = _Endpoint(
            settings={
                'response_type': (JournalList,),
                'auth': [
                    'key'
                ],
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'jci': 'jci',
                    'jci_quartile': 'jciQuartile',
                    'jci_percentile': 'jciPercentile',
                    'page': 'page',
                    'limit': 'limit',
                },
                'location_map': {
        ...
        self.journals_id_cited_year_year_get_endpoint = _Endpoint(
            settings={
                'response_type': (JournalsCited,),
                'auth': [
                    'key'
                ],
        ...
        self.journals_id_citing_year_year_get_endpoint = _Endpoint(
            settings={
                'response_type': (JournalsCiting,),
                'auth': [
                    'key'
                ],
        ...
        self.journals_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (JournalRecord,),
                'auth': [
                    'key'
                ],
        ...
        self.journals_id_history_get_endpoint = _Endpoint(
            settings={
                'response_type': (JournalHistoryRecord,),
                'auth': [
                    'key'
                ],
                'endpoint_path': '/journals/{id}/history',
                'operation_id': 'journals_id_history_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.journals_id_reports_year_year_get_endpoint = _Endpoint(
            settings={
                'response_type': (JournalReports,),
                'auth': [
                    'key'
                ],
    ...
    def journals_get(
        ...
        **kwargs
        ...
        return self.journals_get_endpoint.call_with_http_info(**kwargs)

    def journals_id_cited_year_year_get(
        self,
        id,
        year,
        **kwargs
        ...
        kwargs['year'] = \
            year
        return self.journals_id_cited_year_year_get_endpoint.call_with_http_info(**kwargs)

    def journals_id_citing_year_year_get(
        self,
        id,
        year,
        **kwargs
        ...
        kwargs['year'] = \
            year
        return self.journals_id_citing_year_year_get_endpoint.call_with_http_info(**kwargs)
    ...
    def journals_id_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.journals_id_get_endpoint.call_with_http_info(**kwargs)

    def journals_id_history_get(
        self,
        id,
        **kwargs
    ):
        """Get journal changes by id  # noqa: E501

        Historical changes a journal by ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.journals_id_history_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.journals_id_history_get_endpoint.call_with_http_info(**kwargs)

    def journals_id_reports_year_year_get(
        self,
        id,
        year,
        **kwargs
        ...
        kwargs['year'] = \
            year
        return self.journals_id_reports_year_year_get_endpoint.call_with_http_info(**kwargs)
