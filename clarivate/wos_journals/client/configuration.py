...
from clarivate.wos_journals.client.exceptions import ApiValueError
...
conf = clarivate.wos_journals.client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.clarivate.com/apis/wos-journals/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("clarivate.wos_journals.client")
