...
from clarivate.wos_journals.client import rest
from clarivate.wos_journals.client.configuration import Configuration
from clarivate.wos_journals.client.exceptions import ApiTypeError, ApiValueError, ApiException
from clarivate.wos_journals.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CategoriesApi()
        api_instance.categories_get  # this is an instance of the class Endpoint
        api_instance.categories_get()  # this invokes api_instance.categories_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.categories_get.callable or self.callable in this class
